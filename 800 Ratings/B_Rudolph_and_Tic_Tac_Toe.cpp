...
void solve()
{
    string a, b, c;
    cin >> a >> b >> c;
    if ((a[0] == 'X' && b[0] == 'X' && c[0] == 'X') || (a[1] == 'X' && b[1] == 'X' && c[1] == 'X') || (a[2] == 'X' && b[2] == 'X' && c[2] == 'X') || (a[0] == 'X' && b[1] == 'X' && c[2] == 'X') || (a[2] == 'X' && b[1] == 'X' && c[0] == 'X') || a == "XXX" || b == "XXX" || c == "XXX")
    {
        ot('X');
    }
    else if ((a[0] == '+' && b[0] == '+' && c[0] == '+') || (a[1] == '+' && b[1] == '+' && c[1] == '+') || (a[2] == '+' && b[2] == '+' && c[2] == '+') || (a[0] == '+' && b[1] == '+' && c[2] == '+') || (a[2] == '+' && b[1] == '+' && c[0] == '+') || a == "+++" || b == "+++" || c == "+++")
    {
        ot('+');
    }
    else if ((a[0] == 'O' && b[0] == 'O' && c[0] == 'O') || (a[1] == 'O' && b[1] == 'O' && c[1] == 'O') || (a[2] == 'O' && b[2] == 'O' && c[2] == 'O') || (a[0] == 'O' && b[1] == 'O' && c[2] == 'O') || (a[2] == 'O' && b[1] == 'O' && c[0] == 'O') || a == "OOO" || b == "OOO" || c == "OOO")
    {
        ot('O');
    }
    else
