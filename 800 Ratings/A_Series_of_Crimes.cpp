...
void solve()
{
    ...
    if (v[0].fi != v[1].fi && v[0].sc != v[1].sc)
    {
        if (v[0].fi != v[2].fi && v[1].sc != v[2].sc)
        {
            ot(v[0].fi << " " << v[1].sc);
        }
        else
    ...
    else if (v[0].fi != v[2].fi && v[0].sc != v[2].sc)
    {
        if (v[0].fi != v[1].fi && v[2].sc != v[1].sc)
        {
            ot(v[0].fi << " " << v[2].sc);
        }
        else
    ...
    else if (v[1].fi != v[2].fi && v[1].sc != v[2].sc)
    {
        if (v[1].fi != v[0].fi && v[2].sc != v[0].sc)
        {
            ot(v[1].fi << " " << v[2].sc);
        }
        else
